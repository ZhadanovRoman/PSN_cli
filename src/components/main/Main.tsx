...
import firstImg from '../../../public/Images/1.jpg';
import secondImg from '../../../public/Images/2.jpg';
import thirdImg from '../../../public/Images/3.jpg';
        ...
        <main className={styles.main}>
            <section className={styles.hero}>
                <div className={`${styles.hero__container} container`}>
                    ...
                    <div className={styles.hero__images}>
                        <Image src={firstImg.src} alt="first" className={styles.hero__img} width={300} height={300} />
                        <Image src={secondImg.src} alt="second" className={styles.hero__img} width={300} height={300} />
                        <Image src={thirdImg.src} alt="third" className={styles.hero__img} width={300} height={300} />
                    </div>
                </div>
            </section>
            ...
            <section className={styles.gallery}>
                <div className={styles.gallery__container}>
                    ...
                    <div className={styles.gallery__top}>
                        ...
                        <Slider
                            firstPic={slider1pic1}
                            secondPic={slider1pic2}
                            thirdPic={slider1pic3}
                            fourthPic={slider1pic4}
                            fifthPic={slider1pic5}
                            sixthPic={slider1pic6} />
                    </div>
                    <Parallax />
                    <div className={styles.gallery__bottom}>
                        <div className={styles.gallery__top_block}>
                            <h2 className={`${styles.gallery__bottom_title} container`}>педикюр</h2>
                            <p className={`${styles.gallery__top_descr} container`}>- Smart педикюр гигиенический (обработка пальчиков или стоп) -900₽</p>
                            <p className={`${styles.gallery__top_descr} container`}>- Smart педикюр гигиенический (обработка пальчиков и стоп) -1600₽</p>
                            <p className={`${styles.gallery__top_descr} container`}>- Smart педикюр с покрытием гель-лаком (обработка пальчиков + покрытие гель-лаком+ обработка стоп) -2000₽</p>
                            <p className={`${styles.gallery__top_descr} container`}>- Smart педикюр с покрытием обычным лаком (обработка пальчиков + покрытие обычный лаком + стопы) -1700₽</p>
                            <p className={`${styles.gallery__top_descr} container`}>- Smart педикюр с покрытием обычным лаком (обработка пальчиков + покрытие обычным лаком) -1000₽</p>
                        </div>
                        <Slider 
                            firstPic={slider1pic1}
                            secondPic={slider1pic2}
            ...
            <section className={styles.map}>
                <div className={styles.map__container}>
                    <h3 className={`${styles.map__container_title} container `}>Место расположения</h3>
                    <Map />
                </div>
