...
import { MaskedInput } from 'react-hook-mask'; // Проверьте, что это правильный импорт
...
// Создайте интерфейс для пропсов MaskedInput, если это необходимо
                ...
                <Controller
                    ...
                    rules={{ 
                        ...
                        validate: (value) => {
                            ...
                            return digitsOnly.length === 10 || 'Введите полный номер телефона';
                        }
                    }}
                    render={({ field }) => (
                        <MaskedInput
                            ...
                            onChange={(e) => {
                                console.log('Текущее значение инпута при изменении:', e.target.value);
                            }}
                        />
                    )}
                />
